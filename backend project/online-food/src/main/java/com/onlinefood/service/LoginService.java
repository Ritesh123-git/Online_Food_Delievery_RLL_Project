...
import com.onlinefood.bean.Login;
import com.onlinefood.repository.LoginRepository;
...
public class LoginService {
	...
	public String signIn(Login login) {
		...
		if(result.isPresent()) {
				...
				else if(login.getTypeOfUser().equals(ll.getTypeOfUser()) && login.getTypeOfUser().equals("employee")){
					return "employee successfully login";
				}
				else {
